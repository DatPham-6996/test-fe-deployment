...
export function TicketType({ className }: IconProps) {
  // const fillColor =
  //   color === 'pink' ? '#CF5E9E' : color === 'blue' ? '#367EB3' : color === 'yellow' ? '#F1BC40' : '#DD4B56';

  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className={classnames('fill-neutral-500', className)}>
      <g>
        ...
        <path d="M10 7.25C9.59 7.25 9.25 6.91 9.25 6.5V4C9.25 3.59 9.59 3.25 10 3.25C10.41 3.25 10.75 3.59 10.75 4V6.5C10.75 6.91 10.41 7.25 10 7.25Z" />
        <path d="M10 14.5802C9.59 14.5802 9.25 14.2402 9.25 13.8302V10.1602C9.25 9.75016 9.59 9.41016 10 9.41016C10.41 9.41016 10.75 9.75016 10.75 10.1602V13.8302C10.75 14.2502 10.41 14.5802 10 14.5802Z" />
        <path d="M10 20.75C9.59 20.75 9.25 20.41 9.25 20V17.5C9.25 17.09 9.59 16.75 10 16.75C10.41 16.75 10.75 17.09 10.75 17.5V20C10.75 20.41 10.41 20.75 10 20.75Z" />
      </g>
    </svg>
  );
}
